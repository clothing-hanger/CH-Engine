		...
		elseif health <= 0 then -- Game over
			if settings.practiceMode then
				...
				if fixedLivesCount < 1 then 
					...
					health = 20
					revive = love.audio.newSource("music/pixel/game-over-end.ogg", "stream")
					revive:play()
				end
			end
		end
	...
	drawUI = function(self)
		love.graphics.push()
			...
			if not settings.downscroll then
				if not spirit then
					...
					love.graphics.rectangle("fill", -200 , 50, 2000, 200)
				end
			end
			...
			if not settings.suddenDeath then
				if settings.downscroll then
					if spirit then
						graphics.setColor(1, 60 / 255, 110 / 255) -- opponent health bar color
					else
						graphics.setColor(1, 170 / 255, 111 / 255)
					end
					love.graphics.rectangle("fill", -60, -55, 120, 5)
					graphics.setColor(123 / 255, 214 / 255, 246 / 255) -- player health bar color
		...
		if settings.practiceMode then
			if settings.extraLives then
				if settings.downscroll then
					if spirit then 
						love.graphics.print("PRACTICE MODE" .. "|Highest Combo: " .. highestCombo, -120, -50)
						love.graphics.print("Time Remaining: " .. timeLeftFixed, -50, 30)
						love.graphics.print("Extra Lives: " .. livesCount .. "|Score: " .. score, -120, -70)
					else
					...
					if spirit then
						love.graphics.print("PRACTICE MODE" .. "|Highest Combo: " .. highestCombo, -120, 50)
						love.graphics.print("Time Remaining: " .. timeLeftFixed, -50, -45)
						love.graphics.print("Extra Lives: " .. livesCount .. "|Score: " .. score, -120, 59)
					else
						love.graphics.setColor(0, 0, 0)
						love.graphics.print("PRACTICE MODE" .. "|Highest Combo: " .. highestCombo, -120, 50)
						love.graphics.print("Time Remaining: " .. timeLeftFixed, -50, -45)
				...
				if settings.downscroll then
					if spirit then
						love.graphics.print("PRACTICE MODE" .. "|Highest Combo: " .. highestCombo .. "|Score: " .. score, -120, -50)
						love.graphics.print("Time Remaining: " .. timeLeftFixed, -50, 30)
					else
						love.graphics.setColor(0, 0, 0)
						love.graphics.print("PRACTICE MODE" .. "|Highest Combo: " .. highestCombo .. "|Score: " .. score, -120, -50)
			...
			if settings.extraLives then
				if settings.downscroll then
					if spirit then
						love.graphics.print("Highest Combo: " .. highestCombo .. "|Extra Lives: " .. livesCount .. "|Score: " .. score, -120, -50)
						love.graphics.print("Time Remaining: " .. timeLeftFixed, -50, 30)
					else
						love.graphics.setColor(0, 0, 0)
						love.graphics.print("Highest Combo: " .. highestCombo .. "|Extra Lives: " .. livesCount .. "|Score: " .. score, -120, -50)
				...
				if settings.downscroll then
					if spirit then 
						love.graphics.print("Highest Combo: " .. highestCombo .. "|Score: " .. score, -120, -50)
						love.graphics.print("Time Remaining: " .. timeLeftFixed, -50, 30)
					else
						love.graphics.setColor(0, 0, 0)
						love.graphics.print("Highest Combo: " .. highestCombo .. "|Score: " .. score, -120, -50)
		...
		love.graphics.rectangle("line", 20, 95, 10, 10) -- up
		love.graphics.rectangle("line", 20, 106, 10, 10) -- down
		love.graphics.rectangle("line", 9, 106, 10, 10) -- left
		love.graphics.rectangle("line", 31, 106, 10, 10) -- right


		love.graphics.setColor(1, 1, 1)

		if input:down("gameUp") then
			love.graphics.rectangle("fill", 20, 95, 10, 10)
		end

		if input:down("gameDown") then
			love.graphics.rectangle("fill", 20, 106, 10, 10)
		end

		if input:down("gameLeft") then
			love.graphics.rectangle("fill", 9, 106, 10, 10)
		end

		if input:down("gameRight") then
			love.graphics.rectangle("fill", 31, 106, 10, 10)
		end
	end,
