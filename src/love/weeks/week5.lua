		...
		if not scaryIntro then
			love.graphics.push()
				...
				if not settings.suddenDeath then
					if settings.downscroll then
						if monster then
							graphics.setColor(243 / 255, 1, 110 / 255)  -- opponent health bar color
						else
							graphics.setColor(175 / 255, 103 / 255, 206 / 255) -- opponent health bar color
						end
			...
			--	end
				...
				if sicks == 0 then -- stolen straight out of meme mod lmfao
					graphics.setColor(0, 0, 0)
