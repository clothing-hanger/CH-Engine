...
return {
	enter = function(self, from, songNum, songAppend)
		...
		winColors = {
			{49, 162, 253}, -- Blue            how the fuck are these not divided by 255?
			{49, 253, 140}, -- Green
			{251, 51, 245}, -- Magenta
			{253, 69, 49}, -- Orange
			{251, 166, 51}, -- Yellow
		...
		if simoc then -- if you play as simoc
	...
	update = function(self, dt)
		...
		--testLength = inst:tell("seconds")             dont uncomment this stuff it was just for testing
		--testLengthTwo = inst:getDuration("seconds")

		--testLengthThree = testLengthTwo - testLength
		--testLengthFour = math.floor(testLengthThree)
		--testLengthFive = math.ceil(testLengthThree)
	...
	draw = function(self)
		...
		love.graphics.push()
			...
			love.graphics.push()
				...
				enemy:draw()
				boyfriend:draw()
			--	love.graphics.print("Down Up" .. testLengthFour .. testLengthFive, 0, -350)
			love.graphics.pop()
